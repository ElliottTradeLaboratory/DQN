...
void createOSystem(
    ...
    if (theOSystem->settings().getString("random_seed") == "time") {
      ...
      assert(seed >= 0);
      std::cout << "srand((unsigned)seed) " << seed << std::endl;
      srand((unsigned)seed);
    }
...
void ALEInterface::Impl::loadROM(const std::string &rom_file) {
    //std::cout << "ALEInterface::Impl::loadROM" << std::endl;
...
bool ALEInterface::Impl::loadState() {
    //std::cout << "ALEInterface::Impl::loadState" << std::endl;
    return m_emu->environment->load();
}


bool ALEInterface::Impl::game_over() const {
    //std::cout << "ALEInterface::Impl::game_over" << std::endl;
...
void ALEInterface::Impl::reset_game() {
	//std::cout << "ALEInterface::Impl::reset_game()" << std::endl;
    m_emu->environment->reset();
}


void ALEInterface::Impl::saveState() {
    //std::cout << "ALEInterface::Impl::saveState" << std::endl;
    m_emu->environment->save();
}

std::string ALEInterface::Impl::getSnapshot() const{
    //std::cout << "ALEInterface::Impl::getSnapshot" << std::endl;
...
void ALEInterface::Impl::restoreSnapshot(const std::string &snapshot) {
    //std::cout << "ALEInterface::Impl::restoreSnapshot" << std::endl;
...
{
    //std::cout << "ALEInterface::Impl::Impl" << std::endl;
    loadROM(rom_file);
}
