...
void StellaEnvironment::reset() {
  ...
  if (m_stochastic_start){
    //printf("StellaEnvironment::reset() stochastic_start\n");
    noopSteps = 60 + rand() % NUM_RANDOM_ENVIRONMENTS;
  }else{
    //printf("StellaEnvironment::reset() NOT stochastic_start\n");
    noopSteps = 60;
  }
  ...
  if (m_use_starting_actions) {
    //printf("StellaEnvironment::reset() m_use_starting_actions\n");
    ActionVect startingActions = m_settings->getStartingActions();
    for (size_t i = 0; i < startingActions.size(); i++){
      //printf("StellaEnvironment::reset() m_use_starting_actions %l\n", i);
